...
class B115IntradayFallbackSourceTest {
    ...
    @Test fun oneMinuteYahooHistoryIsBoundedAndThreeMinuteUsesRealOneMinuteAggregation() {
        ...
        assertTrue(interval.contains("OhlcvResampler.aggregate(oneMinute, timeframe.storedMinutes)"))
    }

    @Test fun userInterfaceDisclosesDelayedFallbackAndDoesNotClaimRealtime() {
        val src = source("java/tr/borsatakip/v5/ui/BistScanActivity.kt")
        ...
        assertTrue(src.contains("Yahoo Finance ${'$'}{tf.label} yedek/gecikmeli teknik analiz hazır"))
